...
//UTF-8
<<<<<<< HEAD
//doc.ver：v2.01 20190410  
//#include <cvidef.h>	//use under CVI platform

//definition of interface card
=======
//文件版本：v2.01 20190410  
//#include <cvidef.h>	//使用CVI平台开发，请使用该语句。

//接口卡类型定义
>>>>>>> 5bb58840ed6063a5cdc76019197f11f38dfcaaf2
...
/*------------------------------------------------function and datatype compatible ZLG------------------------------------------------*/
//1.datatype of ZLGCAN interface card
...
//2.define datatype of CAN frame
...
//3. define datatype of CAN config
...
typedef struct _VCI_FILTER_RECORD {
	DWORD ExtFrame;	// is extend frame
	DWORD Start;
	DWORD End;
